...
if (isset($_GET[$flash])) {
	echo "<script>alert('Welcome to blog flog you are successfully registerd at world of blogging....blogFlog.Start posting blogs and following other bloggers.Happy Blogging!')</script>";
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="vendor/kendo/styles/kendo.default.mobile.min.css">
				...
				<div class="paperGenerater">
					<form action="generate.php" method="POST" target="_blank" onsubmit="return validateForm()">
						<table cellspacing="10">
							...
							<tr>
								<td colspan="2"><input id="examFrom" placeholder="From" name="examFrom" value="8:30 AM"></td>
							</tr>
							<tr>
								<td colspan="2"><input id="examTo" placeholder="To" name="examTo" value="9:30 AM"></td>
							</tr>
							<tr>
								<td colspan="2">
									<input type="number" min="1" name="totalMarks" class="formInput" placeholder="Total Marks" value="100">
								</td>
							</tr>
							<tr>
								<td colspan="2">
